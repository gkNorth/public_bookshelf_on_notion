  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
      <div class="container-fluid">
        <nuxt-link class="navbar-brand text-light" to="/">BoN</nuxt-link>
        <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="width: 28px; height: 28px; opacity: 1; cursor: pointer;" xml:space="preserve" @click="pageReload">
          ...
          C512.014,192.446,486.844,134.565,446.025,92.206z" style="fill: rgb(248, 249, 250);"></path>
        </svg>
      </div>
    </nav>
  </header>
